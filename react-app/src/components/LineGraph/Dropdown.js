...
const Dropdown = ({ trackWeight, dataPoint, setDataPoint, monthNames, isEditFormOpen, setIsEditFormOpen, errors, setErrors }) => {
    ...
    const [entryCreatedAt, setEntryCreatedAt] = useState('')
    ...
    const editRequest = (e) => {
        e.preventDefault()
        if (!entryBodyWeight && !entryBenchPress && !entrySquat && !entryDeadlift && !entryCreatedAt) return setErrors(['Cannot update as an empty entry.'])
        ...
        dispatch(updateEntry({ entryId, entryBodyWeight, entryBenchPress, entrySquat, entryDeadlift, entryCreatedAt }))
        setIsSaved(true)
        setEntryBodyWeight('')
        setEntryBenchPress('')
        setEntrySquat('')
                                ...
                                <form onSubmit={editRequest}>
                                    <div className='container flex justify-around w-full items-center'>
                                        ...
                                        <input
                                            ...
                                            placeholder={selectedEntry.body_weight || 'No recorded weight'}
                                        >
                                        </input>
                                    </div>
                                    <div className='container flex justify-around w-full items-center'>
                                        ...
                                        <input
                                            ...
                                            placeholder={selectedEntry.bench_press || 'No recorded weight'}
                                        >
                                        </input>
                                    </div>
                                    <div className='container flex justify-around w-full items-center'>
                                        ...
                                        <input
                                            ...
                                            value={entrySquat}
                                            placeholder={selectedEntry.squat || 'No recorded weight'}
                                        >
                                        </input>
                                    </div>
                                    <div className='container flex justify-around w-full items-center'>
                                        ...
                                        <input
                                            ...
                                            value={entryDeadlift}
                                            placeholder={selectedEntry.deadlift || 'No recorded weight'}
                                        >
                                        </input>
                                    </div>
                                    <div className='container flex justify-around w-full items-center'>
                                        ...
                                        <input
                                            className='bg-input-light border-2 custom-border-color field-focus h-6 p-1 w-1/2'
                                            type='date'
                                            onChange={e => setEntryCreatedAt(e.target.value)}
